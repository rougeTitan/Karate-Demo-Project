...
Feature: Tests for the home page
    ...
    Scenario: Get 10 articles from the page
        #def mean variable
        #read means creating an object to access file content
...
@ignore
    ...
    Scenario: Sleep call
        #if you want to pause the execution for certain time
        #here we are executing java code through function()
